...
- Linux server (_pref._ RHEL/CentOS/Fedora/Rocky)
...
3. Optionally, register SSL certificates with Cloudflare (you may also provide your own; be sure to have the paths to your certificates recorded prior to running)
4. Optionally, configure Nginx
5. Configure custom Docker network (prefined to use _172.20.0.0/16; feel free to modify this to suit your preferences/needs)
